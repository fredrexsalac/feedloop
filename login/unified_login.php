...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        // Check if user exists in users table (admin only)
                    ...
                    if ($admin) {
                        ...
                        switch (strtolower($position)) {
                            case 'super admin':
                                ...
                                $redirect_url = '../admin/super_admin/super_admin_dashboard.php';
                                break;
                            case 'admin':
                            default:
                                $user_type = 'Admin';
...
<body>
    <div class="login-container">
        <div class="login-card">
            ...
            <div class="login-links">
                ...
                <p>Don't have an account? <a href="../admin/register.php">Register as Admin</a></p>
    ...
    <script src="../assets/js/login/unified_login.js"></script>
</body>
</html>
