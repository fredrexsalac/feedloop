<?php
/**
 * FeedLoop v2.0 - System Feedback View
 * 
 * This page displays only System Feedback submissions with anonymized data
 * for privacy protection. Admins can view and respond to system-specific feedback.
 */
...
try {
    $stmt = $pdo->prepare("SELECT COUNT(*) FROM feedback_submissions WHERE feedback_category = 'System Feedback'");
    $stmt->execute();
    $total_system_feedback = $stmt->fetchColumn();
    ...
    $where_conditions = ["feedback_category = 'System Feedback'"];
    $params = [];
    ...
    $error = "Error loading system feedback: " . $e->getMessage();
}
?>

<div class="dashboard-header">
    <h1><i class="fas fa-cog me-2"></i>System Feedback</h1>
    <p>View and manage feedback about the FeedLoop system and technical issues</p>
</div>
...
<div class="row mb-4">
    <div class="col-md-3">
        <div class="stat-card">
            ...
            <div class="stat-number"><?php echo $total_system_feedback; ?></div>
            <div class="stat-label">Total System Feedback</div>
        </div>
    </div>
    <div class="col-md-3">
        <div class="stat-card">
            ...
            <div class="stat-number">
                <?php 
                $stmt = $pdo->prepare("SELECT COUNT(*) FROM feedback_submissions WHERE feedback_category = 'System Feedback' AND admin_response IS NULL");
                $stmt->execute();
    ...
    <div class="col-md-3">
        <div class="stat-card">
            ...
            <div class="stat-number">
                <?php 
                $stmt = $pdo->prepare("SELECT COUNT(*) FROM feedback_submissions WHERE feedback_category = 'System Feedback' AND admin_response IS NOT NULL");
                $stmt->execute();
                echo $stmt->fetchColumn();
                ?>
            </div>
    ...
    <div class="col-md-3">
        <div class="stat-card">
            ...
            <div class="stat-number">
                <?php 
                $stmt = $pdo->prepare("SELECT COUNT(*) FROM feedback_submissions WHERE feedback_category = 'System Feedback' AND DATE(created_at) = CURDATE()");
                $stmt->execute();
                echo $stmt->fetchColumn();
                ?>
            </div>
...
<div class="card mb-3">
    <div class="card-header">
        <h5><i class="fas fa-filter me-2"></i>Filter System Feedback</h5>
    </div>
    <div class="card-body">
...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h3><i class="fas fa-list me-2"></i>System Feedback Submissions</h3>
    ...
    <div class="card-body">
        <?php if (empty($feedback_list)): ?>
            <div class="text-center py-4">
                ...
                <h5 class="text-muted">No system feedback found</h5>
                <p class="text-muted">System feedback submissions will appear here.</p>
            </div>
        <?php else: ?>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                ...
                                <br><small class="text-muted">System Feedback</small>
                            </td>
                            <td>
